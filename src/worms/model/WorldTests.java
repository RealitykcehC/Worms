...
public class WorldTests {
	...
	public void testConstructorWorld_IllegalWidth(){
		World world = new World(5.0,5.0, passable, ran);
		try{
			world = new World(illegalCoordinate,5.0, passable, ran);
	...
	public void testIsValidHeight_IllegalCoordinateCase(){
		World world;
		try{
		world = new World (illegalCoordinate*10.0, illegalCoordinate, passable, ran);
		}catch (IllegalArgumentException exc){
			fail("Height is invalid, out of the world bounds");
		}
