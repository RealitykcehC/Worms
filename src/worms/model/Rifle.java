...
public class Rifle extends Projectile {
	 ...
	 * 
	 * @param worm
	 * 			The worm to which this rifle belongs
	 * @post	The given worm must be equal to the worm that has to shoot.
	 * 			| (new this).getWorm() == worm
	 * @post	The x-coordinate has to be located at the radius of the worm to which this rifle belongs, while respecting the orientation of the worm.
	 * 			| (new this).getX() == worm.getX() + (Math.cos(worm.getOrientation()) * worm.getRadius())
	 * @post	The y-coordinate has to be located at the radius of the worm to which this rifle belongs, while respecting the orientation of the worm.
	 ...
	 * 			The x- and y-coordinate of this rifle have to be valid x- and y-coordinates. If they are not, an exception has to be thrown.
