...
public class WormTests {
	...
	private boolean [][] passable = {{true,true,true,false,false},
									{true,true,true,false,false},
									{true,true,true,false,false},
									{true,true,true,false,false},
									{false,false,false,false,false}};
	private World world = new World (5.0, 5.0, passable, ran);
	private Worm worm = new Worm(world, 1.0, 1.0, 1.0, 1.0, "AllValidWorm");
	...
	@Test
	public void testCanFall_legalCase(){
		
		assertTrue(world.isPassable(worm.getX(), worm.getY(),worm.getRadius()));
		
	}
	@Test
	public void testFall_legalCase(){
		
		assertTrue(world.isPassable(worm.getX(),worm.getY(),worm.getRadius()));
		worm.fall;
		assertTrue(world.isAdjacent(worm.getX(), worm.getY(),worm.getRadius()));
		
	}
	@Test
	public void testShoot(){
		double act = worm.getActionPoints();
		worm.shoot();
		assertTrue(act == worm.getActionPoints());
	}
	...
	public void testSetRadius_IllegalCase(){
		worm.setRadius(0.1);
		assertFalse(worm.getRadius()== 0.1);
